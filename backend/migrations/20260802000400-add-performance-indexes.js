...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.addIndex('notifications', ['userId'], { name: 'idx_notifications_user_id' });
    ...
    await queryInterface.addIndex('leads', ['assignedToId'], { name: 'idx_leads_assigned_to_id' });
    await queryInterface.addIndex('leads', ['leadOwnerId'], { name: 'idx_leads_lead_owner_id' });
    ...
    await queryInterface.addIndex('deals', ['assignedToId'], { name: 'idx_deals_assigned_to_id' });
    await queryInterface.addIndex('deals', ['stage'], { name: 'idx_deals_stage' });

    // Tasks — "my tasks" and status-board views.
    await queryInterface.addIndex('tasks', ['assignedToId'], { name: 'idx_tasks_assigned_to_id' });
